...
$processes = Import-Csv "$rep\*BackupJobSummaryReport*details.xls" -delimiter "`t" | where {$_.Status -ne "N/A" -and $_.Status -ne "Failed" -and $_.Status -ne "Delayed"}
...
$xlout = "$sources\07_completed.xlsx"
$i = 1 
